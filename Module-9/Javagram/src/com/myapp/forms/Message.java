        ...
        if(type == 0) {
                ...
                protected void paintComponent(Graphics g) {
                    ...
                    try {
                        BufferedImage bottom = ImageIO.read(new File(
                                "resources/message-in-bottom.png"
                        ));
                        g.drawImage(
                                bottom,
                                35,
            ...
            messagePane = new JPanel() {
                ...
                protected void paintComponent(Graphics g) {
                    ...
                    try {
                        BufferedImage bottom = ImageIO.read(new File(
                                "resources/message-out-bottom.png"
                        ));
                        g.drawImage(
                                bottom,
                                this.getWidth() - 35 - 307,
                    ...
                    try {
                        BufferedImage left = ImageIO.read(new File(
                                "resources/message-out-right.png"
                        ));
                        g.drawImage(left,
                                this.getWidth() - 35,
                                this.getHeight() / 2 - 6,
